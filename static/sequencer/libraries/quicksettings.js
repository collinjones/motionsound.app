...
(function () {
    ...
    var QuickSettings = {
        ...
        mouseHovering: function (id) {
            if (mouseX > this.getPanelPosition(id).x && mouseX < this.getPanelPosition(id).x + this.getPanelDimensions(id).width &&
                mouseY > this.getPanelPosition(id).y && mouseY < this.getPanelPosition(id).y + this.getPanelDimensions(id).height) {
                    return true;
                }
            return false;
        },
        ...
        getPanelPosition: function () {
            var e = document.getElementById(this.getID()).getBoundingClientRect();
            return {
                "x": e.left,
                "y": e.top,
            }
